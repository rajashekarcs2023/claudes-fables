---
name: child-guardian
description: Use to check every generated Claude's Fables fable for child-safety and pedagogy before it reaches a child. Grades the fable against rubric.md Part B, fails anything unsafe or preachy, triggers one regeneration, and surfaces the catch for the studio panel. The visible safety gate is core to the product, not optional.
---
