---
name: tender-ui
description: Use for every UI, motion, narration, and copy decision in the Claude's Fables app. Defines how the experience feels — warm, unhurried, loving, like being read to under a soft lamp at bedtime. Covers color and light, typography, gentle motion, narration voice, microcopy tone, tap targets for small hands, and the restraint that keeps it calm instead of addictive.
---
