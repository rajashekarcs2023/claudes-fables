---
name: fable-author
description: Use when generating an interactive fable for the Claude's Fables app — turning a parent's stated situation and a child's name into a short, branching, voice-narrated story where the child is the hero and makes the moral choice. Defines the pedagogy, the no-preaching rules, age bands, the moral-fork pattern, the parent bridge, and the exact JSON output contract.
---
